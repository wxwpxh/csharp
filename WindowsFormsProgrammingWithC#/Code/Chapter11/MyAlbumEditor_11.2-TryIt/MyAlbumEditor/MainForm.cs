...
namespace MyAlbumEditor
{
	...
	public class MainForm : System.Windows.Forms.Form
	{
		...
		private void menuImages_Click(object sender, System.EventArgs e)
		{
			...
			tcImages.Alignment = TabAlignment.Bottom;
			tcImages.Multiline = true;
		...
		private void newPage_Paint(object sender, PaintEventArgs e)
		{
			TabPage page = sender as TabPage;
			Photograph photo = null;
			if (page != null)
				photo = page.Tag as Photograph;

			if (photo != null)
			{
				// Draw image with a 3D border
				Rectangle imageRect = photo.ScaleToFit(page.ClientRectangle);
				e.Graphics.DrawImage(photo.Image, imageRect);
				System.Windows.Forms.ControlPaint.DrawBorder3D(
					e.Graphics, imageRect, Border3DStyle.Sunken);
			}
		}
