...
namespace MyPhotos
{
	...
	public class MainForm : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.MenuItem menuFirst;
		...
		private void InitializeComponent()
		{
			...
			// menuFirst
			// 
			this.menuFirst.Index = 2;
			this.menuFirst.Shortcut = System.Windows.Forms.Shortcut.CtrlShiftF;
			this.menuFirst.Text = "&First";
			this.menuFirst.Click += new System.EventHandler(this.menuFirst_Click);
			// 
			// menuLast
			// 
			this.menuLast.Index = 5;
			this.menuLast.Shortcut = System.Windows.Forms.Shortcut.CtrlShiftL;
		...
		private void menuFirst_Click(object sender, System.EventArgs e)
		{
			if ((_album.Count > 0) && (_album.CurrentPosition != 0))
			{	
		...
		{
			if ((_album.Count > 0) && (_album.CurrentPosition != _album.Count - 1))
			{	
