...
namespace Manning
{
	namespace MyPhotoAlbum
	{
		...
		public class PhotoAlbum : CollectionBase, IDisposable
		{
			...
			private const int _CurrentVersion = 67;
			...
			public void Save(string fileName)
			{
				...
				try
				{
					...
					sw.WriteLine(_currentPos.ToString());
			...
			public void Open(string fileName)
			{
				...
				try
				{
					...
					if (version == 67)
						savedPosition = Int32.Parse(sr.ReadLine());
				}
				catch
				{
					version = 0;
				...
				// We rely on the CurrentPosition property to handle the
				// case where savedPosition is an invalid value.
