...
namespace MyAlbumData
{
	...
	public class MainForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// cmbxPhotographer
			// 
			this.cmbxPhotographer.Anchor = (System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right);
			this.cmbxPhotographer.Location = new System.Drawing.Point(264, 78);
			this.cmbxPhotographer.MaxDropDownItems = 4;
			this.cmbxPhotographer.Name = "cmbxPhotographer";
			this.cmbxPhotographer.Size = new System.Drawing.Size(136, 21);
			this.cmbxPhotographer.TabIndex = 12;
			// 
			// dtpDateTaken
			// 
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			// Assign data source for combo box.  Note that this relies on the fact
			// that our _album field retains the same value throughout the life of
			// the program.
			cmbxPhotographer.DataBindings.Add("Text", _album, "Photographer");
			cmbxPhotographer.DataSource = _album.GetPhotographers();
		}
