...
namespace Manning.MyPhotoAlbum
{
	public class AlbumEditDlg : Manning.MyPhotoAlbum.BaseEditDlg
	{
		...
		private System.Windows.Forms.ToolTip toolTipAlbum;
		...
		private void InitializeComponent()
		{
			...
			this.toolTipAlbum = new System.Windows.Forms.ToolTip(this.components);
			...
			this.toolTipAlbum.SetToolTip(this.txtAlbumFile, "Album file name");
			// 
			// txtTitle
			// 
			...
			this.txtTitle.Text = "";
			this.toolTipAlbum.SetToolTip(this.txtTitle, "Title of album");
			...
			this.toolTipAlbum.SetToolTip(this.rbtnDate, "Display date for photo");
			...
			this.toolTipAlbum.SetToolTip(this.rbtnCaption, "Display caption for photo");
			...
			this.toolTipAlbum.SetToolTip(this.rbtnFileName, "Display file name for photo");
			...
			this.toolTipAlbum.SetToolTip(this.cbtnPassword, "Whether password is required for album");
			...
			this.toolTipAlbum.SetToolTip(this.txtAlbumPwd, "Password string");
			...
			this.toolTipAlbum.SetToolTip(this.txtConfirmPwd, "Confirmed password string");
			// 
			// AlbumEditDlg
			// 
