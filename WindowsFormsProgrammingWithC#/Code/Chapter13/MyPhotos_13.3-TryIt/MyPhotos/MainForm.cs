...
namespace MyPhotos
{
	...
	public class MainForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.menuToolBar.Text = "Tool Bar";
			this.menuToolBar.Click += new System.EventHandler(this.menuBars_Click);
			// 
			// menuStatusBar
			// 
			...
			this.menuStatusBar.Click += new System.EventHandler(this.menuBars_Click);
			// 
			// menuItem8
			// 
		...
		private void menuBars_Click(object sender, System.EventArgs e)
		{
			Control theControl = null;
			
			if (sender == menuToolBar)
				theControl = this.toolBarMain;
			else if (sender == menuStatusBar)
				theControl = this.statusBar1;

			if (theControl != null)
			{
				theControl.Visible = !theControl.Visible;

				// At this point, we know this will not fail
				MenuItem mi = (MenuItem) sender;
				mi.Checked = theControl.Visible;
			}
		}
