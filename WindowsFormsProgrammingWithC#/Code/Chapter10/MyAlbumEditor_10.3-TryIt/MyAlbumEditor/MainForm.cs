...
namespace MyAlbumEditor
{
	...
	public class MainForm : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.ContextMenu ctxtMenuAlbums;
		private System.Windows.Forms.MenuItem menuAddAlbum;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.ctxtMenuAlbums = new System.Windows.Forms.ContextMenu();
			this.menuAddAlbum = new System.Windows.Forms.MenuItem();
			...
			this.groupBox1.ContextMenu = this.ctxtMenuAlbums;
			...
			// ctxtMenuAlbums
			// 
			this.ctxtMenuAlbums.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																						   this.menuAddAlbum});
			// 
			// menuAddAlbum
			// 
			this.menuAddAlbum.Index = 0;
			this.menuAddAlbum.Text = "&Add Album...";
			this.menuAddAlbum.Click += new System.EventHandler(this.menuAddAlbum_Click);
			// 
			// MainForm
			// 
		...
		private void menuAddAlbum_Click(object sender, System.EventArgs e)
		{
			using (OpenFileDialog dlg = new OpenFileDialog())
			{
				...
				if (dlg.ShowDialog() == DialogResult.OK)
				{
					// Only add the select album if it is not already present
					if (!cmbxAlbums.Items.Contains(dlg.FileName))
						cmbxAlbums.Items.Add(dlg.FileName);
				}
			}			
		}
