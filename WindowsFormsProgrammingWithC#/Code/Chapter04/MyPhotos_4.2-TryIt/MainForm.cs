...
namespace MyPhotos
{
	...
	public class MainForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.menuLoad.Select += new System.EventHandler(this.menuLoad_Select);
			// 
			// menuItem1
			// 
			...
			this.menuView.Select += new System.EventHandler(this.menuView_Select);
			// 
			// menuImage
			// 
		...
		// These next two methods enable flyby text to appear even
		// when panels have been added to the status bar.  Not all
		// menus are handled, but this should demonstrate how to
		// implement this behavior in your own applications.
		static bool _restorePanels = false;
		...
		// The Select event handlers that display flyby text
		private void menuLoad_Select(object sender, System.EventArgs e)
		{
			statusBar1.Text = "Loads a photo to display in the window";
		}

		private void menuExit_Select(object sender, System.EventArgs e)
		{
			statusBar1.Text = "Exits the application";
		}

		private void menuView_Select(object sender, System.EventArgs e)
		{
			statusBar1.Text = "Commands related to viewing an image";
		}
