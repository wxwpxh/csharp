This directory contains the code from Chapter 15 of the book.  A separate directory exists for each section in the chapter.  Each of these section directories contains the MyAlbumExplorer and MyPhotoAlbum projects.  Double-click the MyAlbumExplorer.sln in the MyAlbumExplorer directory to open the solution.

An implementation of the TRY IT! sections in this chapter is also provided here.
