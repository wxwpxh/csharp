...
namespace MyAlbumExplorer
{
	...
	public class MainForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.treeViewMain.AfterCollapse += new System.Windows.Forms.TreeViewEventHandler(this.treeViewMain_AfterCollapse);
		...
		private void treeViewMain_AfterCollapse(object sender, System.Windows.Forms.TreeViewEventArgs e)
		{
			...
			// Found an album node, so reset it
			e.Node.Nodes.Clear();
