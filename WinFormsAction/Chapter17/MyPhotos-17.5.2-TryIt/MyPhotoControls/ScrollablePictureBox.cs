...
namespace Manning.MyPhotoControls
{
	...
	[ToolboxBitmap(typeof(ScrollablePictureBox),
				   "ScrollablePictureBox.bmp")]
	public class ScrollablePictureBox : PictureBox
	{
		[Category("Action")]
		[Description("Occurs when a scroll bar is"
					  + " shown and the image is scrolled")]
		...
		[Category("Layout")]
		[DefaultValue(true)]
		[Description("Gets or sets whether the control"
