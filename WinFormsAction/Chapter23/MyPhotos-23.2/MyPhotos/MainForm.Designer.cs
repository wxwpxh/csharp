namespace MyPhotos
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			// menuFilePageSetup
			// 
			this.flybyProvider.SetFlybyText(this.menuFilePageSetup, null);
			this.menuFilePageSetup.MergeAction = System.Windows.Forms.MergeAction.Insert;
			this.menuFilePageSetup.MergeIndex = 7;
			this.menuFilePageSetup.Name = "menuFilePageSetup";
			this.menuFilePageSetup.Size = new System.Drawing.Size(151, 22);
			...
			this.menuFilePrint.MergeIndex = 8;
			...
			this.menuFilePrintPreview.MergeIndex = 9;
			...
			this.toolStripSeparator2.MergeIndex = 10;
			...
			this.menuFileExit.MergeIndex = 11;
			...
			this.menuView.MergeAction = System.Windows.Forms.MergeAction.Insert;
